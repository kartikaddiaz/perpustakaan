...
<div class="container mt-4">
    ...
    <form action="<?php echo e(route('admin.buku.update', $book->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\perpustakaan\resources\views/admin/edit.blade.php ENDPATH**/ ?>