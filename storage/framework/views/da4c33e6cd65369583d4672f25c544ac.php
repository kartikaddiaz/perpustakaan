...
<div class="container mt-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h2 class="mb-0">Laporan Peinjaman Terbaru</h2>
    </div>

        <div class="card-body">
            <?php if(!isset($latestLoans) || empty($latestLoans) || count($latestLoans) === 0): ?>
            ...
            <?php else: ?>
                <div class="table-responsive">
                    <table id="loanTable" class="table table-striped table-bordered align-middle">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $latestLoans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
...
<?php /**PATH C:\laragon\www\perpustakaan\resources\views/admin/laporan.blade.php ENDPATH**/ ?>